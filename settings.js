...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "MALVIN-XD~BtQgVQjZ#JYm6DLFTUHylOpv3zRQBDBNu2jSirCCcfI2GAWrWYsg",
// add your Session Id 

PREFIX: process.env.PREFIX || ".",
// add your prifix for bot

BOT_NAME: process.env.BOT_NAME || "Mabhule v2",
...
OWNER_NUMBER: process.env.OWNER_NUMBER || "263780985944",
// add your bot owner number

OWNER_NAME: process.env.OWNER_NAME || "Mabhule",
// add bot owner name

DESCRIPTION: process.env.DESCRIPTION || "> *© Welcome to Mabhule v2*",
// add bot owner name    
...
DEV: process.env.DEV || "263780985944",
